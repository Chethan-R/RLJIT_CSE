...
<?php
 ...
 <midle><label><b>Staff Name:</b></label><br>
  <input type="text" name="stname" Value=<?php echo $_GET['stname'];?>></midle><br>
  
  <label><b>Password:</b></label><br>
  <input type="text" name="password" Value=<?php echo $_GET['password'];?>    ><br>
  
  <label><b>Email:</b></label><br>
  <input type="email" name="email" Value=<?php echo $_GET['email'];?>    ><br>
  
  <midle><label><b>Adhar Number:</b></label><br>
  <input type="number" name="adhar" value=<?php echo $_GET['adhar'];?> ><br>
  
  <midle><label><b>Mobile:</b></label><br>
  <input type="number" name="staffph" Value=<?php echo $_GET['staffph'];?>></midle><br>
  
  <midle><label><b>Qualification:</b></label><br>
  <input type="text" name="qualification" Value=<?php echo $_GET['qualification'];?>></midle><br>
  
  <midle><label><b>Job Description:</b></label><br>
  <input type="text" name="job" Value=<?php echo $_GET['job'];?>></midle><br>
 <br>
