                    ...
                    $query_run = mysqli_query($con,$query);
						...
						if($query_run)
                        {
							...
							if($query_run_a)
							{
								...
								echo '<script type="text/javascript">alert("Student Data Updated"); 	window.location = "/rljit_cse/hod_homepage.php";</script>';
								
							}
							else{
								//echo '<script type="text/javascript">alert("not updated.")</script>';
								echo '<script type="text/javascript">alert("Student Data Not Updated"); 	window.location = "/rljit_cse/hod_homepage.php";</script>';
							}
						}
						else
						{
							//echo '<script type="text/javascript">alert("sorry.")</script>';
							echo '<script type="text/javascript">alert("ERROR"); 	window.location = "/rljit_cse/hod_homepage.php";</script>';
