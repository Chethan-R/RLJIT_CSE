...
<div class="box">
<center><h2><font color="red">STAFF ADDING</font></h2>
<table>
<form action="/rljit_cse/staff_add2.php" method="POST">
    <div class="col-md-12 col-sm-12">
    <tr><td><b>Staff Name:</b></td>
        <td><label> <input type="text" name="stname" required /></label><br></td></tr>
  
    <tr><td><b>Password:<h6>Min 8 characters &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</h6></b></td>
        <td> <label><input type="text" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="a-z, A-Z, 0-9" required></label><br></td></tr>
  
    <tr><td><b>Email:</b></td>
        <td> <label><input type="email" name="email" required></label><br></td></tr>
		
	<tr><td><b>Adhar Number:</b></td>
        <td> <label><input type="number" name="adhar" required></label><br></td></tr>
  
    <tr><td><b>Mobile:</b></td>
		<td> <label><input type="number" name="staffph" ></label></td></tr><br>
  
    <tr><td><b>Qualification:</b></td>
		<td> <label><input type="text" name="qualification" ></label><br></td></tr>
 
    <tr><td><b>Job Description:</b></td>
       <td> <label><input type="text" name="job" ></label><br></td></tr>
    
    <tr><center> <td>  <input type="submit" name="submit" value="Submit" class="submit_btn"></td></center></tr>
	</div>
