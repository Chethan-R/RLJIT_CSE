...
$result = mysqli_query($con,"SELECT * FROM student where syear='2ndYear'");
?>
...
<div class="title"><center><h2><font color="red">STUDENT VIEW</font></h2></center></div>
   ...
   <div class="table-responsive">  
    ...
    <br />
    <form method="post" action="/rljit_cse/export2.php">
     <input type="submit" name="export2" class="btn btn-success" value="Export" />
    </form>
