...
<!--SIDE BAR-->
	<div id="sidebar-wrapper">
        ...
        <ul class="sidebar-nav" id="sidebar">
          ...
          <li><b><font color="blue">NOTIFICATION</font></b><span class="sub_icon glyphicon glyphicon-link"></span></li>
		  <ul class="sidebar-nav" id="sidebar">
...
<table>
<form action="/rljit_cse/stu_staff_updateins.php" method="post">
